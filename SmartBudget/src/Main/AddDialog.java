...
public class AddDialog extends JDialog {
   ...
   JRadioButton[] outrdbtn = new JRadioButton[9];   //지출
   JRadioButton[] inrdbtn = new JRadioButton[5];   //수입
   
   ButtonGroup inout;
      JRadioButton rdbtnNewRadioButton;   //수입
      JRadioButton rdbtnNewRadioButton_1;   //지출
